  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function handleExportData() {
        ...
        await downloadByData(response.data, '高大上.xlsx');
      }
