  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function handleExportData() {
        ...
        await downloadByData(response.data, 'Go View Data.xlsx');
      }
