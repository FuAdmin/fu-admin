...
from flow.loon_base_view import LoonBaseView
from flow.service.account.account_base_service import account_base_service_ins
from flow.service.format_response import api_response
from flow.service.permission.manage_permission import manage_permission_check
...
from flow.service.workflow.workflow_custom_notice_service import workflow_custom_notice_service_ins
from flow.service.workflow.workflow_permission_service import workflow_permission_service_ins
from flow.service.workflow.workflow_runscript_service import workflow_run_script_service_ins
...
class WorkflowDetailView(LoonBaseView):
    ...
    def patch(self, request, *args, **kwargs):
        ...
        app_name = request.META.get('HTTP_APPNAME')
        workflow_id = kwargs.get('workflow_id')
        from flow.service.account.account_base_service import AccountBaseService
        # 判断是否有工作流的权限
